...
import { useHuddleSettingsModal } from "../store/use-huddle-settings-modal";
import { Volume2, Mic } from "lucide-react";
import { useMemo } from "react";
import { getAudioContextConstructor } from "@/lib/audio-context-types";

/**
 * Huddle Settings Dialog
 *
 * Provides audio device selection, volume controls, and audio processing settings
 * Uses Jotai for state management
 */
export function HuddleSettingsDialog() {
  const [open, setOpen] = useHuddleSettingsModal();
  ...
  const { level: micLevel, isClipping } = useMicLevel(localStream, open);
        ...
        <div className="space-y-4 pt-4 border-t">
          ...
          {outputDevices.length > 0 ? (
            <div className="space-y-2">
              ...
              >
                <SelectTrigger id="speaker-device" className="w-full">
